...
class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    public MyCustomAdapter( Context context, List<CountryModel> countryModels) {
        super(context,R.layout.list_custom_item,countryModels);

        this.context=context;
        this.countryModels=countryModels;
        this.countryModelsList=countryModels;
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvContryName=view.findViewById(R.id.tvCountryName);
        ImageView imageView=view.findViewById(R.id.imageFlag);

        tvContryName.setText(countryModelsList.get(position).getCountry());
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                countryModelsList = (List<CountryModel>) results.values;
